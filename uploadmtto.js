...
enviarBtn.addEventListener('click', async () => {
    ...
    try {
        const tablaDestino = 'ManttoIssues';
        const columnaSecuencia = 'Trans';
        ...
        // Consultar el último número consecutivo (Trans) en la tabla ManttoIssues de Supabase
        ...
        // Asignar el autoincremental al campo Trans
