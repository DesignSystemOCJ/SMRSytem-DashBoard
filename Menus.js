...
const menuConfig = [
  ...
  { type: "link", href: "Projects.html", tooltip: "Projects", icon: "fa-solid fa-diagram-project", label: "Projects" },
  {
    ...
    label: "Settings",
    subItems: [
      { href: "User.html", icon: "fa-solid fa-user-gear", label: "User" },          // <-- Actualizado a User.html
      { href: "Employees.html", icon: "fa-solid fa-users", label: "Employees" }    // <-- Mantiene Employees.html
    ]
  }
];
